 ...
 <Nav/>
{
 ...
 <img className={styles.moviePic} src={IMGPATH+movieDetail.poster_path} alt={movieDetail.title} height='300px'/>
...
<p>{handleDate(movieDetail.release_date)}</p>
  ...
  <QuantityBtn className={styles.quantityBtn} productInfo={movieDetail}/>
</div>
 </div>
 <div className={styles.centerLink}>
 <Link className={styles.homePage} to='/'>Back to HomePage</Link>
 </div>
 </div>
}
<Footer/>
